...
public class FertilityPercentageQuinRunner {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, "FertilityPercentage");
        job.setJarByClass(FertilityPercentageQuinRunner.class);
        job.setMapperClass(FertilityPercentageQuinMapper.class);
        job.setReducerClass(FertilityPercentageQuinReducer.class);
