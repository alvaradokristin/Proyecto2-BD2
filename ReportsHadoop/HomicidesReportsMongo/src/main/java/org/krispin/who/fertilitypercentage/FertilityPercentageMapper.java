...
public class FertilityPercentageMapper extends Mapper<Object, Text, Text, FloatWritable> {
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (columns.length >= 6) {
            ...
            if (educationLevel.isEmpty() || educationLevel.equals("null") || residenceArea.isEmpty() || residenceArea.equals("null") || wealthQuintile.isEmpty() || wealthQuintile.equals("null")) {
