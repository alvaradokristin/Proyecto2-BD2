...
public class PromMaxMinXRegionXSexoDecRunner {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, "HomicidesReport");
        job.setJarByClass(PromMaxMinXRegionXSexoDecRunner.class);
        job.setMapperClass(PromMaxMinXRegionXSexoDecMapper.class);
        job.setReducerClass(PromMaxMinXRegionXSexoDecReducer.class);
