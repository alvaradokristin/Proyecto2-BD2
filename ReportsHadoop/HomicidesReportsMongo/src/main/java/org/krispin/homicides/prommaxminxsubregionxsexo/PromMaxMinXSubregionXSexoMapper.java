package org.krispin.homicides.prommaxminxsubregionxsexo;
...
public class PromMaxMinXSubregionXSexoMapper extends Mapper<Object, Text, Text, FloatWritable> {
            ...
            for (int i = 4; i < columns.length; i++) {
                if (!columns[i].isEmpty() && !columns[i].equals("null")) {
                    if (StringUtils.isNumeric(columns[i])) {
                        ...
                        String keyEl = subregion + "\t" + gender + "\t" + year;
