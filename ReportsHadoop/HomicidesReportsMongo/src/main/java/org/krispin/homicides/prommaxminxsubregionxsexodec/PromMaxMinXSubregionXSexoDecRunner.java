...
public class PromMaxMinXSubregionXSexoDecRunner {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf, "HomicidesReport");
        job.setJarByClass(PromMaxMinXSubregionXSexoDecRunner.class);
        job.setMapperClass(PromMaxMinXSubregionXSexoDecMapper.class);
        job.setReducerClass(PromMaxMinXSubregionXSexoDecReducer.class);
